...
subject{HomePage.create(company_name: 'Example Company', content: 'Lorem ipsum',logo_image: Rack::Test::UploadedFile.new(Rails.root.join('app/assets/image/aa.jpg'), 'image/jpg'),background_image: Rack::Test::UploadedFile.new(Rails.root.join('app/assets/image/aa.jpg'), 'image/jpg')
) }
