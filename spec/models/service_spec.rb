...
RSpec.describe Service, type: :model do
  ...
  it 'To check the validation when creating a new Service' do
    service = Service.new(category: :frontend_development, service_name: 'Valid Service Name', service_description: 'Valid service description within limits',service_image: Rack::Test::UploadedFile.new(Rails.root.join('/home/poolstack/Pictures/model rspec.png'), 'image/png'))
